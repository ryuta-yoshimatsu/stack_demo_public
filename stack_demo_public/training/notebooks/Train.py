...
# ``stack_demo_public/assets/model-workflow-asset.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-stack_demo_public-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.stack_demo_public.stack_demo_public-model", label="Full (Three-Level) Model Name"
)
