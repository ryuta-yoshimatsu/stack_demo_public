...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``stack_demo_public/assets/model-workflow-asset.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in stack_demo_public/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in stack_demo_public/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-stack_demo_public-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.stack_demo_public.stack_demo_public-model", "Full (Three-Level) Model Name")
