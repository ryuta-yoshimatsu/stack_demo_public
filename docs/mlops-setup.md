...
[ML Config](../stack_demo_public/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore stack_demo_public/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [stack_demo_public/databricks.yml](../stack_demo_public/databricks.yml)
and [stack_demo_public/assets/ml-artifacts-asset.yml](../stack_demo_public/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [stack_demo_public/assets/README.md](../stack_demo_public/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../stack_demo_public/assets/README.md)  to propose, test, and deploy
