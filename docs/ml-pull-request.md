...
Opening a pull request will trigger a[workflow](../.github/workflows/stack_demo_public-run-tests.yml) 
...
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/stack_demo_public/stack_demo_public-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/stack_demo_public/stack_demo_public-model)
. 
